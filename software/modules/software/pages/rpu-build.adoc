...
board. All you have to do is to specify SC-OBC Module V1 (`scobc_v1/versal_rpu`)
with the `-b` option to `west build`.

[source,  bash]
----
$ cd ~/myproject/zephyr
$ west build -b scobc_v1/versal_rpu samples/hello_world
----
...
new_bif:
{
    ...
    image
    {
        ...
        { core = r5-lockstep, file = /path/to/myproject/zephyr/build/zephyr/zephyr.elf }
    }
}
----
